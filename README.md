...
|-------|-------------------------------------|
| **Date** | 9 mars 2023 |
| **Version stable** | **0\.5.5 - branche** `master` |
...
| *\-log* |  | Mode moins verbeux à destination des fichiers de logs. Dans ce mode, les affichages et les notifications sont réduits aux strict minimum |
