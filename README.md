...
En réalité, lorsqu'un fichier est "effacé, ses données sont conservées sur le disque dur seul l'accès étant supprimé. L'objectif de cet utilitaire consiste à remplir le disque avec des données aléatoires afin d'ecraser et rremplacer le contenu des fichiers précédemment 'effacés'.

Pour cet utilitaire une partition disque peut être découpée en 3 zones :
...
| **Version stable** | **1.1.1 - branche** `main`                                                                                                       |
...
| *-q*                      | *--quiet*                       |                   | Mode silencieux. Dans ce mode, les affichages et les notifications sont réduits aux strict minimum                                                                                                                                                                   
| *-l*                      | *--log*                       |                   | Mode moins verbeux à destination des fichiers de logs. Sans barres de progression.                                                                                                                                                                     
| *-dbg*                      | *--debug*                       |                   | Tous les messages + informations de debugage.                                             |
| *-nb*                      | *--noprogressbar*                       |                   | Ne pas afficher les barres de progression.                                             |
...
Paramètres :
	- Mode : vidage de dossier
	- Itérations : 1

Vider :
	- 2 éléments à vider :
		- [dossier] /home/jhb/.local/share/Trash/files
		- [dossier] /home/jhb/.local/share/Trash/info
	- Récursivité : oui
	- Profondeur : 1

Estimation de la taille totale de dossier à supprimer ou à vider
Rien à supprimer
Fin des traitements
```
...
> :warning:  **Attention**
> L'item *%trash%* ne fonctionne pas avec l'utilitaire *cron*. Il faut utiliser *\_trash\_* à la place.
