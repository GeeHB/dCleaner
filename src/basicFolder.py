...
class basicFolder(FSObject):
    ...
    #
    def browse(self, folder:str, recurse:bool = False, remove:int = -1):  # pjyright: ignore[reportUnknownParameterType]
    ...
    def sizes(self, element:str = "", recurse:bool = False)->tuple[int,int,int]:
        ...
        try:
            ...
            # ?
            return os.path.getsize(element), 1, totalFolders
        except PermissionError:
            # Je n'ai pas les droits ...
            return 0, 0, totalFolders
